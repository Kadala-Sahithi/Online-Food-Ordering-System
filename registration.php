               ...
               <div class="container">
                  <div class="row">
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
									 ...
									 <div class="form-group col-sm-12">
                                       <label for="exampleTextarea">Student ID/Staff ID</label>
                     ...
                     <div class="col-md-4">
                        ...
                        <hr>
                        <img src="images/BVRIT_LOGO.png" alt="" class="img-fluid" width="300" height="125">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Can book your food without waiting in the queue</a></h4>
                           </div>
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Can book your food when your late</a></h4>
                           </div>
