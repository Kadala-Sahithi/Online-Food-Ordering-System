...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/BMO_LOGO.png" alt="" width="125" height="48"> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/bvrit1.jpeg"  >
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 style="font-family: Give You Glory;" >Order Eat or Take-Out </h1>
					<h5 style="font-family: Cursive; color:white;">(Online Food Ordering System)</h5>
                <div class="container"> </div>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>STEP 1.</span>Choose BVRIT Food Stall</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>STEP 2.</span>Order Food</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step">
						<div style = "position:relative; left:10px; top:30px; ">
                            <a class="step-item step2" href="index.php"> <img class="img-rounded" src="images/eat.png" alt="" width="95" height="80" > </a>
                            ...
                            --></div>
							<h4><span>STEP 3.</span>Eat or take out</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Dishes recently added</h2>
                    <p class="lead">The easiest way to find new dishes</p>
                </div>
                <div class="row">
						...
						<?php 
						$query_fos= mysqli_query($db,"SELECT * FROM dishes order by d_id desc LIMIT 3");
									      while($r=mysqli_fetch_array($query_fos))
										  {
													
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/fos_img/dishes/'.$r['img'].'">
																
															</div>
															<div class="content">
																<h5><a href="dishes.php?fos_id='.$r['fs_id'].'">'.$r['title'].'</a></h5>
																<div class="product-name">'.$r['slogan'].'</div>
																<div class="price-btn-block"> <span class="price">₹'.$r['price'].'</span> <a href="dishes.php?fos_id='.$r['fs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
            ...
            <div class="container">
                        ...
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
									...
									$fs= mysqli_query($db,"select * from fs_category");
									      while($row=mysqli_fetch_array($fs))
										  {
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						$foss= mysqli_query($db,"select * from BVRITFoodStall");  
									      while($rows=mysqli_fetch_array($foss))
										  {
													// fetch records from fs_category table according to catgory ID
													$query= mysqli_query($db,"select * from fs_category where c_id='".$rows['c_id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?fos_id='.$rows['fs_id'].'" > <img src="admin/fos_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?fos_id='.$rows['fs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
