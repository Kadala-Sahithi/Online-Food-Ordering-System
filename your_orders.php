            ...
            <section class="restaurants-page">
                <div class="container">
                    <div class="row">
						...
						$query_fos= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_fos) > 0 )
														{
										  ...
										  while($row=mysqli_fetch_array($query_fos))
										  {
														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">₹<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info" style="font-weight:bold;">Confirmed</button>
																		   <?php 
																			  }
